...
export default function PastRides({ user }: PastRidesProps) {
    ...
    return (
        <div className="mt-6">
            ...
            >
                <span className="font-medium text-gray-800">Past Rides ({rides.length})</span>
            ...
            {isOpen && (
                <div className="mt-2 bg-white border rounded-md shadow-sm overflow-hidden">
                    {loading && (
                        <p className="p-4 text-center text-gray-600">Loading your ride history...</p>
                    )}
                    ...
                    {!loading && !error && rides.length === 0 && (
                        <p className="p-4 text-gray-500 text-sm">No past rides found.</p>
                    )}
